...
public abstract class BaseSliderView {
    ...
    /**
     * Allows the use of {@link Glide} or default to {@link Picasso}
     *
     * @param w the condition to use {@link Glide}
     * @return
     */
    public BaseSliderView withGlide(boolean w) {
        useGlide = w;
        return this;
    }
    ...
    protected void bindEventAndShow(final View v, ImageView targetImageView) {
        ...
        if (!useGlide) {
            ...
            RequestManager rq = Glide.with(targetImageView.getContext());
            if (rq == null) {
                return;
            }
            RequestBuilder rb;
